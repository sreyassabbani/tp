...
const tablesSchema = __schema({
  participant: __table({
    ...
    indexes: [
      ...
      { name: 'participantKey', algorithm: 'btree', columns: [
        'participantKey',
      ] },
    ...
    constraints: [
      { name: 'participant_participant_key_key', constraint: 'unique', columns: ['participantKey'] },
    ],
  }, ParticipantRow),
  room: __table({
    name: 'room',
    indexes: [
      { name: 'archived', algorithm: 'btree', columns: [
        'archived',
      ] },
      { name: 'ownerSessionId', algorithm: 'btree', columns: [
        'ownerSessionId',
      ] },
      { name: 'roomCode', algorithm: 'btree', columns: [
        'roomCode',
      ...
      { name: 'watchHost', algorithm: 'btree', columns: [
        'watchHost',
      ] },
    ],
    constraints: [
  ...
  soundEvent: __table({
    ...
    indexes: [
      ...
      { name: 'soundId', algorithm: 'btree', columns: [
        'soundId',
      ] },
    ],
    constraints: [
      { name: 'sound_event_event_id_key', constraint: 'unique', columns: ['eventId'] },
    ],
  }, SoundEventRow),
});
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("trigger_sound", TriggerSoundReducer),
  __reducerSchema("update_cursor", UpdateCursorReducer),
  __reducerSchema("update_soundboard_policy", UpdateSoundboardPolicyReducer),
);
